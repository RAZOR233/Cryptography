...
def nhang_move(list):
    ...
    return t
def key_create(k):
    w = [0 for i in range(0, Nb*(Nr+1))]
    for i in range(0, Nk):
        w[Nk-1 - i] = (k >> i * 32) & 0b11111111111111111111111111111111
    for i in range(Nk, Nb*(Nr+1)):
        ...
        if i % Nk==0:
            ...
            for j in range(0, 4):
                ...
                # print(hex(subword))
                temp=subword ^ Rcon[i // Nk - 1]
        elif Nk>6 and i % Nk==4 :
            subword = 0
            for j in range(0, 4):
                tmp = (temp >> j * 8) & 0b11111111
                subword += SBox(tmp) << 8 * j
            temp=subword
            # if i==12:
            #     print("happy",hex(subword),hex(temp))
        w[i]=w[i-Nk] ^ temp
    return w
...
def outprint(t,k):
    ...
    for i in range(0, 4):
        ...
        print('')
def encode(s,w):
    m = [[[0 for i in range(0, 4)] for j in range(0, 4)] for o in range(0, Nr+2)]
    for j in range(0, 4):
        for i in range(0, 4):
    ...
    for i in range(0, 4):
        for j in range(0, 4):
            output = output + '{:02x}'.format(m[k+1][j][i])
...
0x8e73b0f7da0e6452c810f32b809079e562f8ead2522c6b7b
1
192
1
